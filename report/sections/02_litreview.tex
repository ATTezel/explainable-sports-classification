...
The broader pool of publicly released sports collections, including the Sports Image Classification dataset of \citet{harkal2023sports}, further illustrates how heterogeneous dataset sizes and class definitions complicate any direct cross-study comparison.
...
Recent comparative evaluations of explainability techniques for image data report that different methods frequently disagree and that no single technique is universally best, which directly motivates pairing more than one method rather than relying on a single saliency map \citep{skliarov2025xaicompare}.
